...
public final class GUI extends Module {
    public final ModeSetting theme = registerMode("Theme", "Lumen", "Lumen", "GameSense", "Clear", "ClearGradient");
    public final ModeSetting scroll = registerMode("Scroll", "Container", "Screen", "Container");
